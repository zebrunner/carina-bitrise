...
import com.zebrunner.carina.bitrise.client.auth.ApiKeyAuth;
import com.zebrunner.carina.bitrise.client.auth.Authentication;
import com.zebrunner.carina.bitrise.client.auth.HttpBasicAuth;
import com.zebrunner.carina.bitrise.client.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("AddonAuthToken", new ApiKeyAuth("header", "Bitrise-Addon-Auth-Token"));
        authentications.put("PersonalAccessToken", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.bitrise.io/v0.1
