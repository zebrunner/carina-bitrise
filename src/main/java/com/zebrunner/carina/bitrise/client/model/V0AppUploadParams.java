...
public class V0AppUploadParams {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultBranchName, gitOwner, gitRepoSlug, isPublic, manualApprovalEnabled, organizationSlug, provider, repoUrl, title, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class V0AppUploadParams {\n");
    ...
    sb.append("    gitRepoSlug: ").append(toIndentedString(gitRepoSlug)).append("\n");
    sb.append("    isPublic: ").append(toIndentedString(isPublic)).append("\n");
    sb.append("    manualApprovalEnabled: ").append(toIndentedString(manualApprovalEnabled)).append("\n");
