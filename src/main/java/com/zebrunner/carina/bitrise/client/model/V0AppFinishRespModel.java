...
public class V0AppFinishRespModel {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class V0AppFinishRespModel {\n");
    
    sb.append("    branchName: ").append(toIndentedString(branchName)).append("\n");
    sb.append("    buildTriggerToken: ").append(toIndentedString(buildTriggerToken)).append("\n");
    sb.append("    isWebhookAutoRegSupported: ").append(toIndentedString(isWebhookAutoRegSupported)).append("\n");
