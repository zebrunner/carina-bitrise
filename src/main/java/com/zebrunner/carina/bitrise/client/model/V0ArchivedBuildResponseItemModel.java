...
public class V0ArchivedBuildResponseItemModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(abortReason, branch, buildArtifacts, buildNumber, commitHash, commitMessage, creditCost, finishedAt, machineTypeId, originalBuildParams, pipelineWorkflowId, pullRequestId, pullRequestTargetBranch, pullRequestViewUrl, slug, stackIdentifier, startedOnWorkerAt, status, statusText, tag, triggeredBy, triggeredWorkflow);
  }
  ...
  public String toString() {
    ...
    sb.append("class V0ArchivedBuildResponseItemModel {\n");
