...
public class OutgoingWebhookApi {
     ...
     */
    public com.squareup.okhttp.Call outgoingWebhookCreateCall(V0AppWebhookCreateParams body, String appSlug, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call outgoingWebhookCreateValidateBeforeCall(V0AppWebhookCreateParams body, String appSlug, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V0AppWebhookCreatedResponseModel> outgoingWebhookCreateWithHttpInfo(V0AppWebhookCreateParams body, String appSlug) throws ApiException {
        com.squareup.okhttp.Call call = outgoingWebhookCreateValidateBeforeCall(body, appSlug, null, null);
        Type localVarReturnType = new TypeToken<V0AppWebhookCreatedResponseModel>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call outgoingWebhookCreateAsync(V0AppWebhookCreateParams body, String appSlug, final ApiCallback<V0AppWebhookCreatedResponseModel> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call outgoingWebhookDeleteCall(String appSlug, String appWebhookSlug, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call outgoingWebhookDeleteValidateBeforeCall(String appSlug, String appWebhookSlug, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'appSlug' is set
        if (appSlug == null) {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V0AppWebhookDeletedResponseModel> outgoingWebhookDeleteWithHttpInfo(String appSlug, String appWebhookSlug) throws ApiException {
        com.squareup.okhttp.Call call = outgoingWebhookDeleteValidateBeforeCall(appSlug, appWebhookSlug, null, null);
        Type localVarReturnType = new TypeToken<V0AppWebhookDeletedResponseModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call outgoingWebhookDeleteAsync(String appSlug, String appWebhookSlug, final ApiCallback<V0AppWebhookDeletedResponseModel> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call outgoingWebhookListCall(String appSlug, String next, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call outgoingWebhookListValidateBeforeCall(String appSlug, String next, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'appSlug' is set
        if (appSlug == null) {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V0AppWebhookListResponseModel> outgoingWebhookListWithHttpInfo(String appSlug, String next, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = outgoingWebhookListValidateBeforeCall(appSlug, next, limit, null, null);
        Type localVarReturnType = new TypeToken<V0AppWebhookListResponseModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call outgoingWebhookListAsync(String appSlug, String next, Integer limit, final ApiCallback<V0AppWebhookListResponseModel> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call outgoingWebhookUpdateCall(V0AppWebhookUpdateParams body, String appSlug, String appWebhookSlug, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call outgoingWebhookUpdateValidateBeforeCall(V0AppWebhookUpdateParams body, String appSlug, String appWebhookSlug, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V0AppWebhookResponseModel> outgoingWebhookUpdateWithHttpInfo(V0AppWebhookUpdateParams body, String appSlug, String appWebhookSlug) throws ApiException {
        com.squareup.okhttp.Call call = outgoingWebhookUpdateValidateBeforeCall(body, appSlug, appWebhookSlug, null, null);
        Type localVarReturnType = new TypeToken<V0AppWebhookResponseModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call outgoingWebhookUpdateAsync(V0AppWebhookUpdateParams body, String appSlug, String appWebhookSlug, final ApiCallback<V0AppWebhookResponseModel> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = outgoingWebhookUpdateValidateBeforeCall(body, appSlug, appWebhookSlug, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V0AppWebhookResponseModel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
