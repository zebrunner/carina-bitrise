...
public class PipelinesApi {
     ...
     */
    public com.squareup.okhttp.Call pipelineAbortCall(V0PipelineAbortParams body, String appSlug, String pipelineId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call pipelineAbortValidateBeforeCall(V0PipelineAbortParams body, String appSlug, String pipelineId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call pipelineAbortAsync(V0PipelineAbortParams body, String appSlug, String pipelineId, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call pipelineListCall(String appSlug, String after, String before, String branch, Integer buildNumber, String commitMessage, Integer limit, String next, String pipeline, String status, String triggerEventType, String workflow, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call pipelineListValidateBeforeCall(String appSlug, String after, String before, String branch, Integer buildNumber, String commitMessage, Integer limit, String next, String pipeline, String status, String triggerEventType, String workflow, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'appSlug' is set
        if (appSlug == null) {
            throw new ApiException("Missing the required parameter 'appSlug' when calling pipelineList(Async)");
        }
        
        com.squareup.okhttp.Call call = pipelineListCall(appSlug, after, before, branch, buildNumber, commitMessage, limit, next, pipeline, status, triggerEventType, workflow, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V0PipelineListResponseModel pipelineList(String appSlug, String after, String before, String branch, Integer buildNumber, String commitMessage, Integer limit, String next, String pipeline, String status, String triggerEventType, String workflow) throws ApiException {
        ApiResponse<V0PipelineListResponseModel> resp = pipelineListWithHttpInfo(appSlug, after, before, branch, buildNumber, commitMessage, limit, next, pipeline, status, triggerEventType, workflow);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V0PipelineListResponseModel> pipelineListWithHttpInfo(String appSlug, String after, String before, String branch, Integer buildNumber, String commitMessage, Integer limit, String next, String pipeline, String status, String triggerEventType, String workflow) throws ApiException {
        com.squareup.okhttp.Call call = pipelineListValidateBeforeCall(appSlug, after, before, branch, buildNumber, commitMessage, limit, next, pipeline, status, triggerEventType, workflow, null, null);
        Type localVarReturnType = new TypeToken<V0PipelineListResponseModel>(){}.getType();
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call pipelineListAsync(String appSlug, String after, String before, String branch, Integer buildNumber, String commitMessage, Integer limit, String next, String pipeline, String status, String triggerEventType, String workflow, final ApiCallback<V0PipelineListResponseModel> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = pipelineListValidateBeforeCall(appSlug, after, before, branch, buildNumber, commitMessage, limit, next, pipeline, status, triggerEventType, workflow, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V0PipelineListResponseModel>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call pipelineListAllCall(String ownerSlug, Integer status, String next, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call pipelineListAllValidateBeforeCall(String ownerSlug, Integer status, String next, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V0PipelineListAllResponseModel> pipelineListAllWithHttpInfo(String ownerSlug, Integer status, String next, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = pipelineListAllValidateBeforeCall(ownerSlug, status, next, limit, null, null);
        Type localVarReturnType = new TypeToken<V0PipelineListAllResponseModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call pipelineListAllAsync(String ownerSlug, Integer status, String next, Integer limit, final ApiCallback<V0PipelineListAllResponseModel> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call pipelineRebuildCall(V0PipelineRebuildParams body, String appSlug, String pipelineId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call pipelineRebuildValidateBeforeCall(V0PipelineRebuildParams body, String appSlug, String pipelineId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call pipelineRebuildAsync(V0PipelineRebuildParams body, String appSlug, String pipelineId, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call pipelineShowCall(String appSlug, String pipelineId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call pipelineShowValidateBeforeCall(String appSlug, String pipelineId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'appSlug' is set
        if (appSlug == null) {
    ...
    public ApiResponse<V0PipelineShowResponseModel> pipelineShowWithHttpInfo(String appSlug, String pipelineId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<V0PipelineShowResponseModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call pipelineShowAsync(String appSlug, String pipelineId, final ApiCallback<V0PipelineShowResponseModel> callback) throws ApiException {
