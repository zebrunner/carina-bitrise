...
public class V0ReleaseCreateGooglePlayParams {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class V0ReleaseCreateGooglePlayParams {\n");
    
    sb.append("    automaticPlayConsoleUpload: ").append(toIndentedString(automaticPlayConsoleUpload)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    packageName: ").append(toIndentedString(packageName)).append("\n");
    sb.append("    releaseBranch: ").append(toIndentedString(releaseBranch)).append("\n");
